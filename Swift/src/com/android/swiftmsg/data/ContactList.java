...
public class ContactList extends ArrayList<Contact> {
	...
	/**
	 * Returns a ContactList for the corresponding recipient URIs passed in. This method
	...
	public String[] getNumbers(boolean scrubForMmsAddress) {
		...
		for (Contact c : this) {
			...
			//It's the easiest to just make sure we only send to the same recipient once.
